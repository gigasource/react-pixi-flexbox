...
import { PositionValues, JustifyValues, FlexDirectionValues, WrapValues, DisplayValues, AlignValues } from './conversions';
export declare type CSSValue = string | number | null | undefined;
